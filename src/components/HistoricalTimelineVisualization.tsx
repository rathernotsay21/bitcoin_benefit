...
export default function HistoricalTimelineVisualization({
  ...
  return (
    <div className="w-full max-w-full overflow-hidden">
      ...
      {/* Timeline Container */}
      <div className="bg-white border border-gray-200 rounded-lg p-6 md:p-8 overflow-hidden">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-lg font-semibold text-gray-900">{yearData.year}</h4>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <div className="text-gray-600">BTC Balance</div>
                        <div className="font-medium">{formatBTC(yearData.btcBalance)}</div>
                      </div>
                      <div>
                        <div className="text-gray-600">USD Value</div>
                        <div className="font-medium text-green-600">{formatUSDCompact(yearData.usdValue)}</div>
                      </div>
                      {yearData.grantCost > 0 && (
                        <div className="col-span-2">
                          <div className="text-gray-600">Grant Cost</div>
                          <div className="font-medium text-blue-600">{formatUSDCompact(yearData.grantCost)}</div>
                        </div>
                      )}
                    </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="text-sm font-medium text-orange-800 mb-1">Grants This Year</div>
                    ...
                    {yearData.grantCost > 0 && (
                      <div className="bg-white p-4 rounded-lg border">
                        <div className="text-sm font-medium text-blue-800 mb-1">Grant Cost This Year</div>
                    ...
                    {/* Total BTC Balance */}
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="text-sm font-medium text-blue-800 mb-1">Total BTC Balance</div>
                      <div className="text-xl font-bold text-blue-900">
                        {formatBTC(yearData.btcBalance)}
                      </div>
                      <div className="text-xs text-blue-700 mt-1">
                    ...
                    {/* USD Value */}
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="text-sm font-medium text-green-800 mb-1">Current USD Value</div>
                    ...
                    {/* Vesting Status */}
                    <div className="bg-white p-4 rounded-lg border">
                      <div className="text-sm font-medium text-gray-800 mb-1">Vesting Status</div>
