...
export const BitcoinStyledIcon: React.FC<IconProps> = ({ 
  className = '', 
  size = 512
}) => {
  return (
    <svg 
      ...
      className={className}
    >
      {/* This is a complex styled Bitcoin logo with gradients and multiple paths */}
      {/* Simplified version for performance - keeping the main structure */}
      <defs>
        <linearGradient id="bitcoinGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FEDD4F" />
          <stop offset="50%" stopColor="#F7931A" />
          <stop offset="100%" stopColor="#ED8A00" />
        </linearGradient>
        <linearGradient id="bitcoinGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FEE993" />
          <stop offset="100%" stopColor="#F38D00" />
        </linearGradient>
      </defs>
