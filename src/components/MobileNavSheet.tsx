    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive 
                        ...
                        : 'text-slate-600 dark:text-slate-700 dark:text-slate-300 hover:text-bitcoin dark:hover:text-bitcoin hover:bg-slate-100 dark:hover:bg-slate-700'
                    )}
                  >
        ...
        <div className="theme-toggle-section flex-shrink-0 border-t border-slate-200 dark:border-slate-700 pt-4 sm:pt-6">
          <button
            onClick={toggleTheme}
            className="flex items-center w-full px-4 py-3 rounded-sm text-slate-600 dark:text-slate-700 dark:text-slate-300 hover:text-bitcoin dark:hover:text-bitcoin hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-300"
            aria-label={`Switch to ${theme === 'dark' ? 'light' : 'dark'} theme`}
          >
            {theme === 'dark' ? (
              <SunIconSolid className="w-6 h-6 mr-4 text-yellow-400 flex-shrink-0" />
            ) : (
              <MoonIconSolid className="w-6 h-6 mr-4 text-slate-600 dark:text-slate-700 dark:text-slate-300 flex-shrink-0" />
            )}
