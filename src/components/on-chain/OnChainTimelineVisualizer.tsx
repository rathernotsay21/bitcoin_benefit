  ...
  return (
    <div className="w-full max-w-full overflow-hidden">
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30 border border-bitcoin-200 dark:border-bitcoin-800 rounded-sm p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-2 mb-2">
            <svg className="w-4 h-4 text-bitcoin-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
            </svg>
            <div className="text-sm font-semibold text-bitcoin-800 dark:text-orange-300 uppercase tracking-wide">
              Total Value
            </div>
          </div>
          ...
          <div className="text-xs text-bitcoin-700 dark:text-orange-400">
            At time of receipt
          </div>
        </div>
      </div>
