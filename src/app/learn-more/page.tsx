            ...
            <section className="hero-gradient py-20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
                    ...
                    <h2 className="text-5xl font-bold text-gray-900 mb-8">
                        ...
                        <span className="text-bitcoin-dark">secure your team?</span>
                    </h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-left mt-12">
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Reduce Turnover</h3>
                                <p className="text-gray-600 leading-relaxed">Give top talent a compelling reason to stay and grow with you.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Total Transparency</h3>
                                <p className="text-gray-600 leading-relaxed">Employees track their grants on-chain, anytime. No more guessing.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Employee Empowerment</h3>
                                <p className="text-gray-600 leading-relaxed">Allow direct contributions so your team can accelerate their savings.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Financial Wellness</h3>
                                <p className="text-gray-600 leading-relaxed">Introduce your team to sound money principles and long-term wealth building.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="card glass glow-orange lg:p-10">
                                <div className="text-center">
                                    ...
                                    <div className="text-lg text-gray-600 mb-6">Currently Vested</div>
                                    <div className="w-full bg-gray-200 rounded-full h-4 mb-4 overflow-hidden">
                                        <div className="bg-bitcoin-gradient h-full rounded-full animate-pulse-slow" style={{ width: '50%' }}></div>
                                    </div>
                                    <div className="text-gray-600">50% vested • 2.5 years remaining</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-24">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="order-2 lg:order-1">
                                <div className="card glass glow-orange lg:p-10">
                                    <div className="text-center">
                                        <div className="text-xl font-bold text-gray-900 mb-6">Employee Dashboard</div>
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                                                <span className="font-medium text-gray-700">Company Grant</span>
                                                <span className="font-bold text-lg">₿0.015</span>
                                            </div>
                                            <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                                                <span className="font-medium text-gray-700">Personal Contributions</span>
                                                <span className="font-bold text-green-600 text-lg">₿0.008</span>
                                            </div>
                                            <div className="border-t-2 pt-4">
                                                <div className="flex justify-between items-center">
                                                    <span className="font-bold text-lg">Total Balance</span>
                                                    <span className="text-2xl font-bold text-bitcoin">₿0.023</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="mb-24">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="card glass glow-orange lg:p-10">
                                <div className="text-center">
                                    <div className="text-lg text-gray-600 mb-6">Historical Performance</div>
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                                        ...
                                        <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                                            ...
                                            <span className="font-bold text-green-600 text-lg">+9,000%</span>
                                        </div>
                    ...
                    <div>
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="order-2 lg:order-1">
                                <div className="card glass glow-orange lg:p-10">
                                    <div className="text-center">
                                        <div className="text-lg text-gray-600 mb-6">Industry Comparison</div>
                                        <div className="space-y-6">
                                            <div>
                                                <div className="flex justify-between mb-2">
                                                    <span className="font-medium">Traditional Benefits</span>
                                                    <span className="font-medium">65% retention</span>
                                                </div>
                                            ...
                                            <div>
                                                <div className="flex justify-between mb-2">
                                                    <span className="font-medium">Bitcoin Vesting</span>
                                                    <span className="font-medium text-green-600">89% retention</span>
                                                </div>
                                                <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
