      ...
      <div className="max-w-md mx-auto px-4 text-center">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8">
          ...
          <div className="space-y-3">
            <button
              onClick={reset}
              className="w-full bg-gradient-to-r from-bitcoin to-orange-500 hover:from-orange-500 hover:to-bitcoin text-white px-6 py-3 rounded-lg transition-all transform hover:scale-105 shadow-lg font-medium"
            >
              Try Again
            </button>
