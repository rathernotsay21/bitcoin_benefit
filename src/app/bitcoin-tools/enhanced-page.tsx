      ...
      <header className="relative overflow-hidden" role="banner">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-8 sm:pb-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed mb-6">
        ...
        <footer className="mt-8" role="contentinfo" aria-labelledby="privacy-notice">
          <Card className="bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700">
            <CardContent className="pt-6">
              <p id="privacy-notice" className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-600 text-center max-w-4xl mx-auto">
