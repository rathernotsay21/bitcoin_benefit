...
export default function LearnMorePage() {
    return (
        <div className="min-h-screen">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left mt-12 max-w-5xl mx-auto">
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Stop the Revolving Door</h3>
                                <p className="text-gray-600 dark:text-white/90 text-sm leading-relaxed mb-2">Give your skilled workers a real reason to stay instead of jumping to the next opportunity.</p>
                                <div className="text-xs text-gray-500 dark:text-white/70 italic">
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Build Trust</h3>
                                <p className="text-gray-600 dark:text-white/90 text-sm leading-relaxed mb-2">Show employees exactly what they're earning with complete transparency - no hidden terms or fine print.</p>
                                <div className="text-xs text-gray-500 dark:text-white/70 italic">
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Compete for Talent</h3>
                                <p className="text-gray-600 dark:text-white/90 text-sm leading-relaxed mb-2">Offer something big companies can't - a benefit that grows with your business success.</p>
                                <div className="text-xs text-gray-500 dark:text-white/70 italic">
                        ...
                        <div className="flex items-start group">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Attract Quality People</h3>
                                <p className="text-gray-600 dark:text-white/90 text-sm leading-relaxed mb-2">Stand out from other small businesses with a modern benefit that shows you invest in your team's future.</p>
                                <div className="text-xs text-gray-500 dark:text-white/70 italic">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-20">
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            <div>
                                <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl flex items-center justify-center mb-6">
                                    <CheckCircleIcon className="w-7 h-7 text-white" />
                                </div>
                                <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                                    Build Trust Through Complete Transparency
                                </h3>
                                <p className="text-lg text-gray-600 dark:text-white/90 leading-relaxed mb-4">
                                ...
                                <div className="bg-gray-100 dark:bg-slate-700 p-4 rounded-xl">
                                    <p className="text-sm text-gray-700 dark:text-white/90 italic">
                                        ...
                                        <span className="block mt-2 font-medium not-italic">- Sarah, Pottery Studio Owner</span>
                                    </p>
                                </div>
                            </div>
                            <div className="card glass glow-orange p-6 lg:p-8">
                                <div className="text-center">
                                    ...
                                    <div className="text-sm text-gray-600 dark:text-white/80">50% vested • 2.5 years remaining</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-600 rounded-xl">
                                                <span className="font-medium text-sm text-gray-700 dark:text-white">Company Grant</span>
                                                <TechnicalDetails 
                                                  summary="₿0.015"
                                            ...
                                            <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl">
                                                <span className="font-medium text-sm text-gray-700 dark:text-white">Personal Contributions</span>
                                                <TechnicalDetails 
                                                  summary="₿0.008"
                            ...
                            <div className="order-1 lg:order-2">
                                ...
                                <div className="bg-gray-100 dark:bg-slate-700 p-4 rounded-xl">
                                    <p className="text-sm text-gray-700 dark:text-white/90 italic">
                                        ...
                                        <span className="block mt-2 font-medium not-italic">- Mike, Auto Shop Owner</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mb-20">
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            <div>
                                <div className="w-14 h-14 bg-bitcoin-gradient rounded-2xl flex items-center justify-center mb-6">
                                ...
                                <div className="bg-gray-100 dark:bg-slate-700 p-4 rounded-xl">
                                    <p className="text-sm text-gray-700 dark:text-white/90 italic">
                                        ...
                                        <span className="block mt-2 font-medium not-italic">- Tom, Construction Company Owner</span>
                                    </p>
                                </div>
                            </div>
                            <div className="card glass glow-orange p-6 lg:p-8">
                                <div className="text-center">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="border-t pt-4 text-xs text-gray-500 dark:text-white/70">
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                <div className="flex justify-between mb-2">
                                                    <span className="font-medium text-sm dark:text-white">Traditional Small Business</span>
                                                    <span className="font-medium text-sm dark:text-white">58% retention</span>
                                                </div>
                                            ...
                                            <div>
                                                <div className="flex justify-between mb-2">
                                                    <span className="font-medium text-sm dark:text-white">With Modern Benefits</span>
                                                    <span className="font-medium text-sm text-green-600 dark:text-green-400">82% retention</span>
                                                </div>
                                                <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3 overflow-hidden">
                                                    <div className="bg-gradient-to-r from-green-400 to-emerald-500 h-full rounded-full" style={{ width: '82%' }}></div>
                                                </div>
                                            </div>
                                            <div className="text-xs text-gray-500 dark:text-white/70 pt-2">
                            ...
                            <div className="order-1 lg:order-2">
                                ...
                                <div className="bg-gray-100 dark:bg-slate-700 p-4 rounded-xl">
                                    <p className="text-sm text-gray-700 dark:text-white/90 italic">
                                        ...
                                        <span className="block mt-2 font-medium not-italic">- Lisa, Coffee Roastery Owner</span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-16 sm:py-20 bg-gray-50 dark:bg-slate-800 transition-colors duration-300">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            <div>
                                <div className="flex items-center mb-6">
                                    <div className="w-14 h-14 bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl flex items-center justify-center mr-4">
                                    <AcademicCapIcon className="w-7 h-7 text-white" />
                                    </div>
                                    <div>
                                        <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Artisan Pottery Studio</h4>
                                        <div className="text-sm text-gray-600 dark:text-white/80">8 employees • Portland, OR</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-white/90 leading-relaxed">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-gray-600 dark:text-white/90 space-y-2">
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Zero instructor turnover in 18 months</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Student satisfaction scores up 34%</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Instructors actively refer qualified candidates</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="card glass glow-orange p-6 lg:p-8">
                                <div className="text-center">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <div className="text-xs text-gray-600 dark:text-white/80 mb-2">Average Instructor Tenure</div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-red-600 dark:text-red-400">Before: 18 months</span>
                                                <span className="text-sm text-green-600 dark:text-green-400">After: 3+ years</span>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="text-xs text-gray-600 dark:text-white/80 mb-2">Training Costs per Year</div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-red-600 dark:text-red-400">Before: $12,000</span>
                                                <span className="text-sm text-green-600 dark:text-green-400">After: $1,200</span>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="text-xs text-gray-600 dark:text-white/80 mb-2">Student Retention</div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-red-600 dark:text-red-400">Before: 67%</span>
                                                <span className="text-sm text-green-600 dark:text-green-400">After: 89%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="space-y-3">
                                            <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
                                                <div className="text-xl font-bold text-green-600 dark:text-green-400">$47,000</div>
                                                <div className="text-xs text-green-700 dark:text-green-300">Saved in recruitment costs</div>
                                            </div>
                                            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                                                <div className="text-xl font-bold text-blue-600 dark:text-blue-400">$23,000</div>
                                                <div className="text-xs text-blue-700 dark:text-blue-300">Reduced training expenses</div>
                                            </div>
                                            <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                                                <div className="text-xl font-bold text-purple-600 dark:text-purple-400">$18,000</div>
                                                <div className="text-xs text-purple-700 dark:text-purple-300">Annual benefit investment</div>
                                            </div>
                                            <div className="border-t pt-3">
                                                <div className="text-xl font-bold text-gray-900 dark:text-white">$52,000</div>
                                                <div className="text-xs text-gray-600 dark:text-white/80">Net annual savings</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="order-1 lg:order-2">
                                <div className="flex items-center mb-6">
                                    <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl flex items-center justify-center mr-4">
                                    <ShieldCheckIcon className="w-7 h-7 text-white" />
                                    </div>
                                    <div>
                                        <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Family Auto Repair</h4>
                                        <div className="text-sm text-gray-600 dark:text-white/80">12 employees • Phoenix, AZ</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-gray-600 dark:text-white/90 space-y-2">
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Three mechanics turned down dealership offers</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Mechanics actively refer qualified friends</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Customer satisfaction up due to consistency</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            <div>
                                <div className="flex items-center mb-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-600 dark:text-white/80">15 employees • Denver, CO</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-gray-600 dark:text-white/90 space-y-2">
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>78% reduction in seasonal turnover</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Crew stays through slow seasons</span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                                                <span>Faster project completion with experienced team</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="card glass glow-orange p-6 lg:p-8">
                                <div className="text-center">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <div className="text-xs text-gray-600 dark:text-white/80 mb-2">Winter Retention Rate</div>
                                            ...
                                            <div className="text-sm text-green-600 dark:text-green-400 font-bold">89% (was 45%)</div>
                                        </div>
                                        
                                        <div>
                                            <div className="text-xs text-gray-600 dark:text-white/80 mb-2">Project Completion Time</div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-red-600 dark:text-red-400">Before: 6.2 weeks</span>
                                                <span className="text-sm text-green-600 dark:text-green-400">After: 4.8 weeks</span>
                                            </div>
                                        </div>
                                        
                                        <div className="pt-4 border-t">
                                            <div className="text-xl font-bold text-gray-900 dark:text-white">$89,000</div>
                                            <div className="text-xs text-gray-600 dark:text-white/80">Annual savings from reduced turnover</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="text-center mt-12">
                        <div className="inline-flex flex-col sm:flex-row items-center sm:space-x-8 space-y-4 sm:space-y-0 p-6 bg-gradient-to-r from-bitcoin/10 to-orange-500/10 dark:from-slate-700 dark:to-slate-600 rounded-2xl">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900 dark:text-white">85%</div>
                                <div className="text-xs text-gray-600 dark:text-white/80">Average retention improvement</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900 dark:text-white">$67K</div>
                                <div className="text-xs text-gray-600 dark:text-white/80">Average annual savings</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900 dark:text-white">4.2x</div>
                                <div className="text-xs text-gray-600 dark:text-white/80">ROI on benefit investment</div>
                            </div>
                        </div>
                    </div>
                </div>
